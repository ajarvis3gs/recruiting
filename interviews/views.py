...
from interviews.models import Availability, InterviewRequest
...
def availability(request, bu_id):
	...
	if request.method == 'GET':
		user_availabiity = user.availability_set.all()
		availability = []
	...
	if request.method == 'POST':
		...
		Availability.objects.bulk_create(available_instances)
