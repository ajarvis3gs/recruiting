...
class Job(models.Model):
    ...
    employer_contact = models.ForeignKey(EmployerContact, related_name='jobs', null=True, blank=True)
    pricing_schedule = models.ForeignKey(EmployerPricingSchedule, related_name='jobs', null=True, blank=True)
    ...
    site = models.ForeignKey(Site, on_delete=models.CASCADE, related_name='jobs', null=True, blank=True)
    ...
    def getJobTitle(self):
        if self.pricing_schedule:
            return self.pricing_schedule.job_title
        else:
            return self.title
