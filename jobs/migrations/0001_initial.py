    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, choices=[(b'onsite', b'On-site'), (b'remote', b'Remote')], max_length=50, null=True)),
                ...
                ('compensation_type', models.CharField(choices=[(b'One-time', b'One-time'), (b'Monthly', b'Monthly')], max_length=25)),
